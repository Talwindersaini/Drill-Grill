<? include"header.php"?>	
 ...
 <ul class="breadcrumb">
        ...
        <li class="active">Edit Evaluators</li>
      </ul>    </div>
    ...
    <?
    extract($_REQUEST);
    $qry="select * from evaluators where id= '$id'";
    $res=mysql_query($qry);
    ...
    <form role='form' class='well form-horizontal' method='post' action='eeval.php'>
	<input type='hidden' value='<?= $id ?>' name='id'>
	<h3 style='margin-top:0'>Edit Evaluators</h3>
